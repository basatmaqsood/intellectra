...
const TeamSection: React.FC = () => {
  ...
  return (
    <div className="bg-[url('/images/team-bg.png')] bg-cover bg-center bg-no-repeat flex flex-col md:flex-row md:items-center md:justify-center gap-8 md:gap-12 lg:gap-16 xl:gap-20 px-8 sm:px-12 md:px-16 lg:px-20 xl:px-32 2xl:px-60 py-50 sm:py-75 md:py-60">
