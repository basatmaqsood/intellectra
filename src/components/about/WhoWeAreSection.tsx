...
const WhoWeAreSection: React.FC = () => {
  return (
    <section className="relative w-full py-16 md:py-20 lg:py-28 xl:py-60  overflow-hidden">
      ...
      <div className="w-full max-w-[90%] sm:max-w-[85%] md:max-w-[80%] lg:max-w-[85%] xl:max-w-[80%] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-center gap-8 lg:gap-12 xl:gap-14">
          
          {/* Left Side - Title */}
          <div className="flex justify-center lg:w-1/3 xl:w-2/5 flex-shrink-0">
